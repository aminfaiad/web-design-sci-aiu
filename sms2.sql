...
ALTER TABLE attendance ADD CONSTRAINT unique_attendance UNIQUE (student_id, course_id);
ALTER TABLE student_marks ADD CONSTRAINT unique_marks UNIQUE (class_id, student_id);
